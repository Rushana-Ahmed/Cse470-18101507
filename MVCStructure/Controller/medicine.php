<?php
  ...
  include_once ('D:\xampp\htdocs\pharmacy\MVCStructure\Model\functions\database_functions.php');
  ...
  include ('D:\xampp\htdocs\pharmacy\MVCStructure\View\template\header.php');
...
?>
      ...
      <div class="row">
        <div class="col-md-3 text-center">
          <img class="img-responsive img-thumbnail" src="./D:/xampp/htdocs/pharmacy/MVCStructure/View/bootstrap/img/<?php echo $row['medicine_image']; ?>">
        </div>
        <div class="col-md-6">
...
include ('D:\xampp\htdocs\pharmacy\MVCStructure\View\template\footer.php');
